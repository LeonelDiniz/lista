...
<body>
        ...
        <form method="post" name="form1" id="form1" action="../Model/insereLista.php">
            <div class="mb-4">
                <label for="exampleInputEmail1" class="form-label"><strong>
                        <h3>Coloque seu nome abaixo</h3>
                    </strong></label>
                <input type="text" class="form-control" minlength="10" maxlength="50" id="fname" name="fname" placeholder="Informe seu nome completo">
    ...
    <div align="center" class="container">
        ...
        <p>Serão atendidos todos que estiverem na <strong>Lista Principal</strong>.</p>
        <br>
        ...
        <p>Em caso de desistência, quem estiver na <strong>Lista de Espera</strong> será automaticamente colocado na Lista Principal.</p>
        <br>
